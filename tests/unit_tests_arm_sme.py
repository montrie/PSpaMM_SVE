...
kernels.append(generator.DenseKernel("sme_base_test7_5", 16, 16, 16, 16, 16, 16, 1.0, 2.0, [x.getBlocksizeBk(v_size, v_size, 16, v_size) for x in blocksize_algs], delta_dp))
...
kernels.append(generator.DenseKernel("sme_base_test8_5", 16, 16, 16, 16, 16, 16, 2.0, 0.0, [x.getBlocksizeBk(v_size, v_size, 16, v_size) for x in blocksize_algs], delta_dp))
...
kernels.append(generator.DenseKernel("sme_base_test9_5", 16, 16, 16, 16, 16, 16, 2.0, 1.0, [x.getBlocksizeBk(v_size, v_size, 16, v_size) for x in blocksize_algs], delta_dp))
...
kernels.append(generator.DenseKernel("sme_base_test10_5", 16, 16, 16, 16, 16, 16, 2.0, 2.0, [x.getBlocksizeBk(v_size, v_size, 16, v_size) for x in blocksize_algs], delta_dp))
...
kernels.append(generator.DenseKernelS("sme_single_base_test7", 32, 32, 32, 32, 32, 32, 1.0, 2.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test8", 32, 32, 32, 32, 32, 32, 2.0, 0.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test9", 32, 32, 32, 32, 32, 32, 2.0, 1.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test10", 32, 32, 32, 32, 32, 32, 2.0, 2.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
...
kernels.append(generator.DenseKernelS("sme_single_base_test12", 64, 64, 64, 64, 64, 64, 1.0, 2.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test13", 64, 64, 64, 64, 64, 64, 2.0, 0.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test14", 64, 64, 64, 64, 64, 64, 2.0, 1.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test15", 64, 64, 64, 64, 64, 64, 2.0, 2.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))

kernels.append(generator.DenseKernelS("sme_single_base_test16", 192, 192, 192, 192, 192, 192, 1.0, 0.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test17", 192, 192, 192, 192, 192, 192, 1.0, 2.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test18", 192, 192, 192, 192, 192, 192, 2.0, 0.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test19", 192, 192, 192, 192, 192, 192, 2.0, 1.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))
kernels.append(generator.DenseKernelS("sme_single_base_test20", 192, 192, 192, 192, 192, 192, 2.0, 2.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], delta_sp))

kernels.append(generator.SparseKernelS("sme_sparse_single_base_test1", 16, 16, 16, 16, 0, 16, 1.0, 0.0, [x.getBlocksize(16, 16, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(16, 16, 25), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test2", 16, 16, 16, 16, 0, 16, 1.0, 2.0, [x.getBlocksize(16, 16, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(16, 16, 25), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test3", 16, 16, 16, 16, 0, 16, 2.0, 0.0, [x.getBlocksize(16, 16, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(16, 16, 25), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test4", 16, 16, 16, 16, 0, 16, 2.0, 1.0, [x.getBlocksize(16, 16, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(16, 16, 25), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test5", 16, 16, 16, 16, 0, 16, 2.0, 2.0, [x.getBlocksize(16, 16, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(16, 16, 25), delta_sp))

kernels.append(generator.SparseKernelS("sme_sparse_single_base_test6", 32, 32, 32, 32, 0, 32, 1.0, 0.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(32, 32, 102), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test7", 32, 32, 32, 32, 0, 32, 1.0, 2.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(32, 32, 102), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test8", 32, 32, 32, 32, 0, 32, 2.0, 0.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(32, 32, 102), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test9", 32, 32, 32, 32, 0, 32, 2.0, 1.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(32, 32, 102), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test10", 32, 32, 32, 32, 0, 32, 2.0, 2.0, [x.getBlocksize(32, 32, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(32, 32, 102), delta_sp))

kernels.append(generator.SparseKernelS("sme_sparse_single_base_test11", 64, 64, 64, 64, 0, 64, 1.0, 0.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(64, 64, 409), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test12", 64, 64, 64, 64, 0, 64, 1.0, 2.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(64, 64, 409), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test13", 64, 64, 64, 64, 0, 64, 2.0, 0.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(64, 64, 409), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test14", 64, 64, 64, 64, 0, 64, 2.0, 1.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(64, 64, 409), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test15", 64, 64, 64, 64, 0, 64, 2.0, 2.0, [x.getBlocksize(64, 64, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(64, 64, 409), delta_sp))

kernels.append(generator.SparseKernelS("sme_sparse_single_base_test16", 192, 192, 192, 192, 0, 192, 1.0, 0.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(192, 192, 3686), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test17", 192, 192, 192, 192, 0, 192, 1.0, 2.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(192, 192, 3686), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test18", 192, 192, 192, 192, 0, 192, 2.0, 0.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(192, 192, 3686), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test19", 192, 192, 192, 192, 0, 192, 2.0, 1.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(192, 192, 3686), delta_sp))
kernels.append(generator.SparseKernelS("sme_sparse_single_base_test20", 192, 192, 192, 192, 0, 192, 2.0, 2.0, [x.getBlocksize(192, 192, v_size_s, v_size_s) for x in blocksize_algs], generator.generateMTX(192, 192, 3686), delta_sp))
